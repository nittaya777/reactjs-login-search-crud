...
export const ProfileEditPassword = (props) => {
  ...
  const { username } = props.profileReducer.data;
      ...
      httpClient
        ...
        .catch((error) => {
          if (error.response.status === 401) {
            ...
            }else if(err_message ==="Username not exist" || err_message ==="username is null"){
          ...
          <FormGroup>
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                setIsErrors({ ...isErrors,new_password:null, confirm_new_password: null });
              }}
              className={
